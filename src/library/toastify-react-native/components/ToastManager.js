    ...
    return (
      <Modal
        animationIn={
          ...
          this.state.animationStyle[this.props.animationStyle].animationIn
        }
        animationOut={
          this.props.animationOut ||
          this.state.animationStyle[this.props.animationStyle].animationOut
        }
        ...
        <View
          ...
          <Text
            //   numberOfLines={2}
            style={[
              //   this.props.textStyle ? this.props.textStyle : styles.textStyle,
              styles.textStyle,
          ...
          <View style={styles.progressBarContainer}>
            <Animated.View
              style={[styles.progressBar, {width: this.state.barWidth}]}
            />
          </View>
        </View>
      </Modal>
