    ...
    actions
      ...
      .then(res => {
        ...
        updateState({
          ...
          freelancer_percentage:res?.freelancer_percentage,
          employee_percentage:res?.employee_percentage
        });
      })
      ...
      <View style={{overflow: 'hidden', borderRadius: moderateScale(10)}}>
        ...
        <View style={{padding: 8}}>
          ...
          <View style={styles.notificationModalMainHeaderStyle}>
            ...
            {freelancer_percentage> 0 ||employee_percentage>0 ? (
              <View style={{alignItems: 'center'}}>
                <Text numberOfLines={1} style={styles.priceTitleTextStyle}>
                  {strings.DRIVER_COMMISSION}
                </Text>
                <Text numberOfLines={1} style={styles.priceTextStyle}>
                  {userData?.type=='Freelancer'?Number(freelancer_percentage)
                      .toFixed(2):Number(employee_percentage)
                      .toFixed(2)}
                </Text>
